...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // If connected to Google, post there too
    if (business.googleLocationId && review.googleReviewId && business.googleRefreshToken) {
      ...
      await postGoogleReply(accessToken, business.googleLocationId, review.googleReviewId, replyText);
    }
    ...
    console.error("Publish reply error:", error);
